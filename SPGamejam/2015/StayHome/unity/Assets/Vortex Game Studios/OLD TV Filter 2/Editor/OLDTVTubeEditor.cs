...
public class OLDTVTubeEditor : Editor {
    ...
    private SerializedProperty _scanlineMultiplier;
    ...
    void OnEnable() {
        ...
        _scanlineMultiplier = serializedObject.FindProperty("scanlineMultiplier");
    ...
    public override void OnInspectorGUI() {
        ...
        if ( _foldScanline ) {
            ...
            _scanlineMultiplier.floatValue = EditorGUILayout.FloatField("Line Multiplier", Target.scanlineMultiplier);
